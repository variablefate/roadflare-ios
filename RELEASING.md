...
- **Next upload:** ready to archive once #123 merges. Run the pre-archive checklist before clicking Archive. After App Store Connect confirms upload, tag `v1.0.3-build4`.
